...
export const AlbahaGallery = ({ isEnglish }) => {
  const gallery_slides_data = [
    {
      title: isEnglish
        ? "Al-Baha in Pictures: Incredible Beauty Captured by the Lens"
        : "الباحة في صور: جمال لا يُصدق بالتقاط العدسة",
      date: "15/2/2025",
      image: "/assets/home/library/photo-1.png",
      type: isEnglish ? "Photo" : "صور",
    },
    {
      title: isEnglish
        ? "Al-Baha in Pictures: Incredible Beauty Captured by the Lens"
    ...
    <div className="w-full px-12 flex flex-col gap-2">
      <div className="w-full flex items-center justify-between">
        <h3 className="text-2xl font-bold mb-4">
          {isEnglish ? "Observatory Photos and Videos" : "صور وفيدوهات المرصد"}
        </h3>
        <Button>
          <Link href="/images">
